...
//
//       Filename:  E:\nx2022\NX\Nx_Win\bin\Debug\zdd.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: QT-254
//              Version: NX 10
//              Date: 04-08-2024  (Format: mm-dd-yyyy)
//              Time: 09:20 (Format: hh-mm)
//
//==============================================================================
...
public class zdd
{
	...
	public zdd()
	{
		try
		{
			...
			theUI = UI.GetUI();
			theDialog = theUI.CreateDialog(Arong_Nx.Arong_Nx_App.GetPath("zdd.dlx"));
	...
	// from the menubar.
	//------------------------------------------------------------------------------
	public static int GetUnloadOption_bak(string arg)
	{
	...
	//------------------------------------------------------------------------------
	public static void UnloadLibrary_bak(string arg)
	{
		try
		{
	...
	public int apply_cb()
	{
		...
		try
		{
			Nx_Win.Form1.point[0] = point0.GetProperties().GetPoint("Point").X;
			Nx_Win.Form1.point[1] = point0.GetProperties().GetPoint("Point").Y;
			Nx_Win.Form1.point[2] = point0.GetProperties().GetPoint("Point").Z;
		}
		catch (Exception ex)
		{
			//---- Enter your exception handling code here -----
